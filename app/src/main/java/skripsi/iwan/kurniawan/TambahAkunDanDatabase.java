...
public class TambahAkunDanDatabase extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_akundandatabase);
        ...
        btnSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(TambahAkunDanDatabase.this, LoginActivity.class);
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(TambahAkunDanDatabase.this, "Sign In Failed",
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(TambahAkunDanDatabase.this, "Registrasi gagal",
                                    Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    ...
    private void onAuthSuccess(FirebaseUser user) {
        ...
        // Go to MainActivity
        startActivity(new Intent(TambahAkunDanDatabase.this, MainActivity.class));
        finish();
    }
    /*
    ...
    private void writeNewAdmin(String userId, String name, String email) {
        ...
        mDatabase.child("datakaryawan").child(userId).setValue(admin);
    }
